...
def about():
    ...
    **Team:** Amit Kumar | **Institution:** Galgotias University

    **GitHub Repo:** [https://github.com/amitkushwaha001/AI_TraceFinder.git](https://github.com/amitkushwaha001/AI_TraceFinder.git)
    """)
