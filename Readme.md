...
## Overview
AI TraceFinder is a forensic machine learning platform that identifies the **source scanner device** used to digitize a document or image. Each scanner (brand/model) introduces unique **noise, texture, and artifacts** to scans—these can be learned and detected for forensic attribution.
...
- Each image resized to **256×256 (grayscale)** and paired with **27 handcrafted features** across **11 scanner classes**

**Data Shapes:**
- Train: `(3654, 256, 256, 1)`, `(3654, 27)`, `(3654, 11)`
- Test: `(914, 256, 256, 1)`, `(914, 27)`, `(914, 11)`
...
![Performance Chart](https://github.com/user-attachments/assets/fbca0f9f-3f0f-4f5e-9c68-f0ce2e48a166)
...
We used a public scanner dataset (link: [NIST OpenMFC](https://www.nist.gov/)).  
You can download manually or use the helper script provided.
...
- **Amit Kumar**
- Email: [amitkushwaha200215@gmail.com](mailto:amitkushwaha200215@gmail.com)
- GitHub: [amitkushwaha001](https://github.com/amitkushwaha001)
